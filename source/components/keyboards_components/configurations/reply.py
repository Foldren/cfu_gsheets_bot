...
from components.keyboards_components.keyboards.reply import keyb_start_admin, keyb_start_user, \
    keyb_start_user_admin, keyb_operation_under_stats, keyb_wallets, keyb_operation_integration_banks
...
cf_keyb_operation_integration_banks = ReplyKeyboardMarkup(
    keyboard=keyb_operation_integration_banks,
    resize_keyboard=True,  # меняем размер клавиатуры
)