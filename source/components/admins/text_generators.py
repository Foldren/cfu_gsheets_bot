async def get_text_start_admin(name_user: str) -> str:
    return f"ВКЛЮЧЕН РЕЖИМ АДМИНА 👨‍💼\n\n" \
           ...
           f"3️⃣ <b>Отчеты</b> - изменение списка наблюдателей для разных периодов ваших отчетов\n\n" \
           f"4️⃣ <b>Режим: Админ</b> 👨‍💼 / <b>Режим: Юзер</b> 🙎‍♂️  - ваш текущий режим работы с ботом, " \
