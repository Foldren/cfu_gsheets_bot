...
from components.keyboards import keyb_str_change_wallets_list
from components.tools import get_callb_content, get_inline_keyb_markup, generate_wallets_status_list, \
    generate_zero_array
from components.users.texts import text_change_wallets_list, text_end_change_wallets_list
